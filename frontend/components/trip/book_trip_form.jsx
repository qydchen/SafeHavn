...
import BookTripContainer from './book_trip_container';

class BookTripForm extends React.Component {
  // constructor(props) {
  //   super(props);
  //   this.state = {
  //     email: '',
 ...
 // 		}
  ...
  //         </span>
  //         <span className="switch" onClick={() => this.clearErrorsAndOpenModal(<BookTripFormContainer formType="login"/>)}>
  ...
  //         </span>
  //         <span className="switch" onClick={() => this.clearErrorsAndOpenModal(<BookTripFormContainer formType="signup"/>)}>
...
export default withRouter(BookTripForm);
